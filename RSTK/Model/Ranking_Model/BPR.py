...
def save_data(name, value):
    save_path = os.path.join('../Data', "bpr_" + name + ".csv")
...
def bpr_mf(user_count,item_count,hidden_dim):
    ...
    item_emb_h = tf.get_variable("item_emb_h", [item_count + 1, hidden_dim],
                                 initializer=tf.random_normal_initializer(0, 0.1))
...
def BPR_train(path):
    user_count,item_count,user_ratings = load_data(path)
